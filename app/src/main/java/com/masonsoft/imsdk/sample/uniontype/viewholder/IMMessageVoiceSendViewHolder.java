...
import com.masonsoft.imsdk.sample.databinding.ImsdkSampleUnionTypeImplImMessageVoiceSendBinding;
...
public class IMMessageVoiceSendViewHolder extends IMMessageVoiceViewHolder {
    ...
    private final ImsdkSampleUnionTypeImplImMessageVoiceSendBinding mBinding;

    public IMMessageVoiceSendViewHolder(@NonNull Host host) {
        super(host, R.layout.imsdk_sample_union_type_impl_im_message_voice_send);
        mBinding = ImsdkSampleUnionTypeImplImMessageVoiceSendBinding.bind(itemView);
    }
