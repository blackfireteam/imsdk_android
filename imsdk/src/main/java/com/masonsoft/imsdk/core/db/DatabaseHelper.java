...
public final class DatabaseHelper {
    ...
    private String[] getSQLIndexTableLocalSendingMessage() {
        return new String[]{
                "create index " + TABLE_NAME_LOCAL_SENDING_MESSAGE + "_index_local_last_modify_ms on " + TABLE_NAME_LOCAL_SENDING_MESSAGE + "(" + ColumnsLocalSendingMessage.C_LOCAL_LAST_MODIFY_MS + ")",
