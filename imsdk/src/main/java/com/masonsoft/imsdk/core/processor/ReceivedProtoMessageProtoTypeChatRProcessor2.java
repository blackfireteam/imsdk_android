 ...
 * @since 1.0
 */
public class ReceivedProtoMessageProtoTypeChatRProcessor2 extends ReceivedProtoMessageProtoTypeProcessor<ProtoMessage.ChatR> {
    ...
    public ReceivedProtoMessageProtoTypeChatRProcessor2() {
